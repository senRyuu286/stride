...
export function DeleteTaskModal({
  ...
  return (
    <div className="modal modal-open modal-bottom sm:modal-middle bg-neutral-900/40 backdrop-blur-sm z-50 p-4">
      ...
      <div className="modal-box relative bg-base-100 border border-base-content/10 shadow-2xl rounded-t-3xl sm:rounded-2xl p-6 w-11/12 max-w-sm z-10 flex flex-col items-center text-center animate-slide-up sm:animate-pop-in">
        ...
        <p className="opacity-80 text-sm sm:text-base mb-6">
          ...
          <span className="font-semibold text-base-content"> "{taskTitle}"</span>? 
